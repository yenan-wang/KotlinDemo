...
import com.ngb.kotlindemo.main.databinding.TemplateViewholderThreeFourLayoutBinding
import com.ngb.kotlindemo.main.second.homepage.fragment.two.TemplateData

class TemplateThreeFourViewHolder(binding: TemplateViewholderThreeFourLayoutBinding) : TemplateViewHolder(binding) {
    private var mBinding = binding

    override fun bindData(data: TemplateData, position: Int) {
        Log.d("ngb_log", "TemplateThreeFourViewHolder:$position")
        mBinding.setVariable(BR.threeFourData, data)
