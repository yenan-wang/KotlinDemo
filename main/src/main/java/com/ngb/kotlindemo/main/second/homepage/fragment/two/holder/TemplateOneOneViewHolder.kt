...
import com.ngb.kotlindemo.main.databinding.TemplateViewholderOneOneLayoutBinding
import com.ngb.kotlindemo.main.second.homepage.fragment.two.TemplateData

class TemplateOneOneViewHolder(binding: TemplateViewholderOneOneLayoutBinding) : TemplateViewHolder(binding) {

    private var mBinding = binding

    override fun bindData(data: TemplateData, position: Int) {
        Log.d("ngb_log", "TemplateOneOneViewHolder:$position")
        mBinding.setVariable(BR.oneOneData, data)
