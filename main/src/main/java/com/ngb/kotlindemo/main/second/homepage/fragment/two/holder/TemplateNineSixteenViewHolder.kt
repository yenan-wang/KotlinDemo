...
import com.ngb.kotlindemo.main.databinding.TemplateViewholderNineSixteenLayoutBinding
import com.ngb.kotlindemo.main.second.homepage.fragment.two.TemplateData

class TemplateNineSixteenViewHolder(binding: TemplateViewholderNineSixteenLayoutBinding) : TemplateViewHolder(binding) {
    private var mBinding = binding

    override fun bindData(data: TemplateData, position: Int) {
        Log.d("ngb_log", "TemplateNineSixteenViewHolder:$position")
        mBinding.setVariable(BR.nineSixteenData, data)
