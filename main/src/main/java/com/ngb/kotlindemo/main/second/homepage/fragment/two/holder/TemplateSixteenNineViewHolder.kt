...
import com.ngb.kotlindemo.main.databinding.TemplateViewholderSixteenNineLayoutBinding
import com.ngb.kotlindemo.main.second.homepage.fragment.two.TemplateData

class TemplateSixteenNineViewHolder(binding: TemplateViewholderSixteenNineLayoutBinding) : TemplateViewHolder(binding) {
    private var mBinding = binding

    override fun bindData(data: TemplateData, position: Int) {
        Log.d("ngb_log", "TemplateSixteenNineViewHolder:$position")
        mBinding.setVariable(BR.sixteenNineData, data)
